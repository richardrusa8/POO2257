...
public class Empleado extends Persona {
    ...
    public Empleado(int numeroEmpleado, String departamento, float sueldo, int horasExtra, Dirección domicilio) {
    ...
    public Empleado(int numeroEmpleado, String departamento, float sueldo, int horasExtra, Dirección domicilio, String nombre, String apPaterno, String apMaterno, int edad, String curp) {
